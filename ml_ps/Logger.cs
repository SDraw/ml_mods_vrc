namespace ml_ps
{
    static class Logger
    {
        static MelonLoader.MelonLogger.Instance ms_melonLogger = new MelonLoader.MelonLogger.Instance("PanoramaScreenshot");
        ...
        public static void DebugMessage(string p_message) => MelonLoader.MelonDebug.Msg("[PanoramaScreenshot] " + p_message);
    }
}
