namespace ml_lme
{
    static class Logger
    {
        static MelonLoader.MelonLogger.Instance ms_melonLogger = new MelonLoader.MelonLogger.Instance("LeapMotionExtension");
        ...
        public static void DebugMessage(string p_message) => MelonLoader.MelonDebug.Msg("[LeapMotionExtension] " + p_message);
    }
}
