namespace ml_alg
{
    static class Logger
    {
        static MelonLoader.MelonLogger.Instance ms_melonLogger = new MelonLoader.MelonLogger.Instance("AvatarLimbsGrabber");
        ...
        public static void DebugMessage(string p_message) => MelonLoader.MelonDebug.Msg("[AvatarLimbsGrabber] " + p_message);
    }
}
