namespace ml_arh
{
    static class Logger
    {
        static MelonLoader.MelonLogger.Instance ms_melonLogger = new MelonLoader.MelonLogger.Instance("AvatarRealHeight");
        ...
        public static void DebugMessage(string p_message) => MelonLoader.MelonDebug.Msg("[AvatarRealHeight] " + p_message);
    }
}
